 ...
 */
package org.avbravo.jmoordbreport.entity;
...
import org.avbravo.jmoordbreport.domains.Utilidades;
import org.avbravo.jmoordbreport.entity.Atributos;
import org.avbravo.jmoordbreport.entity.Embedded;
import org.avbravo.jmoordbreport.entity.Entidad;
import org.avbravo.jmoordbreport.entity.Referenced;
import org.avbravo.jmoordbreport.domains.MySubreportSession;
 ...
 */
public class EntityReaderSubReport implements Serializable {
    ...
    public Boolean readEntity(String name, String texto) {
        try {
            ...
            if (!searchId(texto)) {
                ...
                MySubreportSession.getMensajesInformacion().add(name + " No tiene Primary Key");
                
            } else {
                MySubreportSession.setAllTablesWithPrimaryKey(true);
            }
            ...
            MySubreportSession.getEntidadList().add(entidad);
            MySubreportSession.setEntidad(entidad);
        } catch (Exception e) {
